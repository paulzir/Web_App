...
if(isset($_GET['page'])){
	...
	if ($check=='customer'){
		...
		$sql = "SELECT COUNT(customerid) FROM customers WHERE customers.lastname LIKE '%$searchterm%' OR customers.afm LIKE '%$searchterm%' ";
	...
	$query = "SELECT * FROM customers WHERE customers.lastname LIKE '%$searchterm%' OR customers.afm LIKE '%$searchterm%'ORDER BY customerid DESC LIMIT $offset, $rec_limit";
   ...
   <?php		
		...
		$sql = "SELECT COUNT(prod_id) FROM products, categories WHERE products.prod_name LIKE '%$searchterm%' AND products.prod_cat=categories.cat_id OR cat_name LIKE '%$searchterm%' AND products.prod_cat=categories.cat_id ";
		$retval = mysqli_query($link,$sql);
		...
		" WHERE prod_name LIKE '%$searchterm%' AND products.prod_cat=categories.cat_id OR cat_name LIKE '%$searchterm%' AND products.prod_cat=categories.cat_id  ORDER BY products.prod_id DESC LIMIT $offset, $rec_limit ";    
		$results = mysqli_query($link,$query);
